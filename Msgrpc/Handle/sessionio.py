...
class SessionIO(object):
    ...
    def update(ipaddress=None, sessionid=None):
        ...
        try:
            ...
            output = base64.b64decode(new_bufer)
            ...
            result = Xcache.add_sessionio_cache(ipaddress, output)
    ...
    @staticmethod
    def run(sessionid=None, user_input=None):
        ...
        try:
            ...
            if result is None:
                ...
                while True:
                    ...
                    if result is None or (isinstance(result, dict) is not True):
                        context = data_return(303, {}, SessionIO_MSG_ZH.get(303), SessionIO_MSG_EN.get(303))
                        return context
                    ...
                    if output == '':
                        ...
                        if first_output_count > first_output_wait:
                            break
                        ...
                        first_output_count = 0
                        wait_output_count += 1
                        if wait_output_count > wait_output_max:
                            break
                ...
                context = data_return(200, output_total, CODE_MSG_ZH.get(200), CODE_MSG_EN.get(200))  # code特殊处理
                return context
            else:
                context = data_return(305, {}, SessionIO_MSG_ZH.get(305), SessionIO_MSG_EN.get(305))
                return context
