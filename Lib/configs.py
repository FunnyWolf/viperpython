...
PostModuleActuator_MSG_EN = {
    ...
    308: "Initialization module failed, please check the configuration of OpenAI and other LLM",
}
...
LLMModule_MSG_EN = {
    204: "Delete history messages successfully",
}
Setting_MSG_ZH = {
    201: "获取chat_id列表成功",
    202: "设置Telegram通知成功",
    ...
    217: "设置SMTP配置成功",
    218: "新增用户成功",
    221: "更新360Quake API成功",
    231: "删除Quake API KEY 成功",
    232: "删除用户成功",
    233: "删除配置成功",
    ...
    311: "输入的OpenAI配置不可用,请检查api_key和base_url是否正确",
    312: "输入的SMTP置不可用,请检查配置",
    313: "新增用户失败",
    314: "删除用户失败",
}
...
Setting_MSG_EN = {
    ...
    215: "Set common configuration success",
    216: "Set OpenAI config success",
    218: "Create user success",
    221: "Update 360Quake API success",
    231: "Delete Quake API KEY success",
    232: "Delete user success",
    233: "Delete config success",
    ...
    311: "The entered OpenAI configuration is not available, please check if the api_key and base_url is correct",
    313: "Fail to create user",
    314: "Delete user failed",
}
...
Port_MSG_EN = {
    201: "Update port information successfully",
...
VIPER_WORK_CHANNEL = "VIPER_WORK_CHANNEL"
...
LLMMODULE_CHANNEL_GROUP = "LLMModuleChannelGroup"

LOAD_PATH_KEY = "load_path"
USER_ID_KEY = "user_id"

# llm
USER_INPUT = "user_input"
ES_MAX_COUNT = 10000
ES_MAX_COUNT_IPDOMAIN = 10
