...
class SessionLib(object):
    ...
    def to_json(self):
        data = {
            ...
            "is_in_admin_group": self.is_in_admin_group,
            "is_admin": self.is_admin,
            "is_uac_enable": self.is_uac_enable,
            "uac_level": self.uac_level,
            ...
            "puser": self.puser,
            "parch": self.parch,
            "load_powershell": self.load_powershell,
            "load_python": self.load_python,
            "domain": self.domain,
            ...
            "user": self.user,
            "os": self.os,
            "logged_on_users": self.logged_on_users,
            "tunnel_peer": self.tunnel_peer,
            "tunnel_local": self.tunnel_local,
            "comm_channel_session": self.comm_channel_session,
