...
class BROKER(object):
    ...
    llm_python_module = 'llm_python_module'
...
class TAG2TYPE(object):
    ...
    debug = 'debug'  # '调试模块'
    # Web模块
    Web_Auto_Module = "Web_Auto_Module"  # 自动化模块
    Web_Company_Intelligence = "Web_Company_Intelligence"  # 企业情报
    Web_Network_Scan = "Web_Network_Scan"  # 网络扫描
    Web_CyberSecurity_Scan = "Web_CyberSecurity_Scan"  # 安全扫描
    ...
    AI_RAG = 'AI_RAG'  # 'AI_RAG'
    AI_Multi_Agent = 'AI_Multi_Agent'  # 'AI_MULTI_RAG'
